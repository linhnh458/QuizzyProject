...
<html lang="zxx">
    <head>
        ...
        <title>Add answer for question</title>
        <!-- Custom CSS -->
                                        ...
                                        <div class="dashboard_wrap">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 mb-4">
                                                    <h6 class="m-0">Answer details</h6>
                                                </div>
                                            </div>
                                            <div class="row justify-content-center">
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <div class="form-group smalls">
                                                        ...
                                                        <input class="form-control" name="qid" value="${requestScope.qid}" readonly/>
                                                    </div>
                                                    <div class="form-group smalls">
                                                        <label>Content *</label>
                                                        <input type="text" class="form-control" name="content" value="${sessionScope.tempContent}" required/>
                                                    </div>
                                                    <div class="form-group smalls">
                                                    ...
                                                    <div class="form-group smalls">
                                                        <input type="submit" class="btn theme-bg text-white" value="Add answer">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
