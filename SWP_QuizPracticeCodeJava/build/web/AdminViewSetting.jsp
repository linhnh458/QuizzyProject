                                                        ...
                                                        <div class="tab-content" id="v-pills-tabContent">
                                                            ...
                                                            <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                                                                ...
                                                                <div class="form-group smalls">
                                                                    ...
                                                                    <input name="duration" type="number" class="form-control" value="${setting.quizDuration}" readonly>
                                                                </div>
                                                                <div class="form-group smalls">
                                                                    <label>Number of question</label>
                                                                    <input name="quesNum" type="number" class="form-control" value="${setting.numberOfQuestion}" readonly>
                                                                </div>
                                                                <div class="form-group smalls">
                                                                    <label>Max answers per question</label>
                                                                    <input name="maxAns" type="number" class="form-control" value="${setting.maxNumAnswerPerQuest}" readonly>
                                                                </div>
                                                                <div class="form-group smalls">
                                                                    <label>Status</label>
                                                                    <input name="status" class="form-control" value="${setting.status}" readonly>
                                                                </div>

                                                                <div class="justify-content-between">
                                                                    <a href="setting">
                                                                        <input class="btn text-white full-width theme-bg" value="Back to list">                                                                        
                                                                    </a>
                                                                </div>    
                                                            </div>
                                                        </div>
