                    ...
                    <div class="row">
                        ...
                        <c:choose>
                            <c:when test="${isDoingQuiz}">
                                ...
                                <a href="QuizHandle?quesnum=1" style="margin-left: 10px;" class="btn btn-success">Continue the last attempt</a>
                            </c:when>
                            <c:otherwise>
                                <%@include file="PracticeNew.jsp" %>
                                <button style="margin-left: 10px;" class="btn btn-success">Simulation Exam</button>
                            </c:otherwise>
                        </c:choose>
                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="drp-select dropdown-menu">
                                                            <a class="dropdown-item" href="practicedetail?id=${p.quizId.getQuizId()}">View</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <!--                                                                            <td>
