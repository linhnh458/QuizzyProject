...
public class DimensionDAO extends DBContext {
    ...
    public List<Dimension> getSubjectDimension(int sid) {
        ...
        String sql = "select d.*,typeName from Dimension d join DimensionType t"
                + " on d.typeId = t.typeId where subjectID = ? ";
        try {
...
//        }
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Dimension> d = (ArrayList<Dimension>) db.getAllDimension();
